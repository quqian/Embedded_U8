...
enum{
    ...
    DEBUG_CMD_SET_RTC                          	= 0x15,//0x15 设置RTC时钟
    DEBUG_CMD_RED_RTC                          	= 0x16,//0x16 读取RTC时钟
    DEBUG_CMD_FLASH                            	= 0x17,//0x17 Flash读写测试
	DEBUG_CMD_SET_LISTEN_MODE                  	= 0x18,	//0x18
    DEBUG_CMD_QUE_LISTEN_MODE                  	= 0x19,	//0x19
    DEBUG_CMD_LED                              	= 0x1a,//0x1a Led指示灯测试
    DEBUG_CMD_485                              	= 0x1b,//0x1b 485接口测试
    DEBUG_CMD_NET_CONNECT                      	= 0x1c,//0x1c 后台对接测试
    DEBUG_CMD_4G_TO_2G                         	= 0x1d,//0x1d 设置4G兼容2G
    DEBUG_CMD_GET_CHARGER_SN                   	= 0x1e,//0x1e 获取桩编号
    DEBUG_CMD_GET_DEVICE_ID                    	= 0x1f,//0x1f 获取识别码
    START_AGE_TEST                             	= 0x20,//0x20 启动老化测试
    GET_AGE_TEST_RESULT                        	= 0x21,//0x21 获取老化测试结果
    GET_CMD_RS232                        		= 0x28, //0x28 RS232
    GET_CMD_U8_CARD                        		= 0x2B, //U8用这条刷卡命令
